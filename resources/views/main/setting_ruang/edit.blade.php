                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="ruang_nama" name="ruang_nama"
                                               placeholder="Tulis nama ruang..."
                                               value="{{ old('ruang_nama') ?? $ruang->ruang_nama }}">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="ruang_lokasi">Lokasi Ruang</label>
                                        <input type="text" class="form-control" id="ruang_lokasi" name="ruang_lokasi"
                                               placeholder="Tulis lokasi ruang..."
                                               value="{{ old('ruang_lokasi') ?? $ruang->ruang_lokasi }}">
                                    </div>
                                </div>
                                    ...
                                    @foreach($dataKepalaLab as $kalab)
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="gridCheck"
                                                   name="list_approver[]" value="{{$kalab->user_id}}" {{!empty($kalab->approver_id) ? 'checked' : ''}}>
